...
st.title("📈 Commodity Plastics Forecasting")
...
# ✅ Corrected Iterative Random Forest Forecast
def forecast_rf_iterative(train_df, future_dates, lags=10):
    ...
    last_known = df_all.iloc[-lags:]["y"].values[-lags:]
    preds = []
    ...
    for _ in range(len(future_dates)):
        ...
        preds.append(yhat)
        last_known = np.append(last_known, yhat)
...
rf_fc = forecast_rf_iterative(df, future_dates)
